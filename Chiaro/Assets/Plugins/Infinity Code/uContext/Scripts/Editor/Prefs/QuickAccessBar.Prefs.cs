    ...
    public partial class Prefs
    {
        ...
        public class QuickAccessBarManager : StandalonePrefManager<QuickAccessBarManager>
        {
            ...
            private void AddItem(ReorderableList list)
            {
                ...
                menu.AddItem(new GUIContent("Add Window"), false, () => AddItem(QuickAccessItemType.window));
                menu.AddItem(new GUIContent("Add Static Method"), false, () => AddItem(QuickAccessItemType.staticMethod));
                menu.AddItem(new GUIContent("Add Menu Item"), false, () => AddItem(QuickAccessItemType.menuItem));
                menu.AddItem(new GUIContent("Add Scriptable Object"), false, () => AddItem(QuickAccessItemType.scriptableObject));
                menu.AddItem(new GUIContent("Add Settings"), false, () => AddItem(QuickAccessItemType.settings));
                menu.AddItem(new GUIContent("Add Space"), false, () => AddItem(QuickAccessItemType.space));
                menu.AddItem(new GUIContent("Add Flexible Space"), false, () => AddItem(QuickAccessItemType.flexibleSpace));
                menu.ShowAsContext();
            }
                ...
                if (GUI.Button(r, "Select") && methodType != null)
                {
                    ...
                    foreach (MethodInfo method in methods)
                    {
                        if (method.GetParameters().Length == 0 && !method.IsSpecialName)
                        {
                            ...
                            menu.AddItem(new GUIContent(methodName), false, () =>
                            {
