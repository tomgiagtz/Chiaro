...
namespace InfinityCode.uContext
{
    public static partial class Prefs
    {
        ...
        private class ZoomShortcutManager : PrefManager, IHasShortcutPref
        {
            ...
            {
                zoomShortcut = EditorGUILayout.ToggleLeft("Zoom By Shortcut", zoomShortcut, EditorStyles.boldLabel);
