...
namespace InfinityCode.uContext
{
    public static partial class Prefs
    {
        ...
        private class RotateByShortcutManager : PrefManager, IHasShortcutPref
        {
...
#endif
                rotateByShortcut = EditorGUILayout.ToggleLeft(label, rotateByShortcut, EditorStyles.boldLabel);
            }
