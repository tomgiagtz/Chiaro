...
namespace InfinityCode.uContext
{
    public static partial class Prefs
    {
        ...
        public static Vector2Int contextMenuWindowSize = new Vector2Int(400, 300);
        ...
        public class ContextMenuMainManager : StandalonePrefManager<ContextMenuMainManager>, IHasShortcutPref
        {
            ...
            public override void Draw()
            {
                ...
                DrawFieldWithHotKey("Show Context Menu On Hot Key", ref contextMenuOnHotKey, ref contextMenuHotKey, ref contextMenuHotKeyModifiers);

                contextMenuWindowSize = EditorGUILayout.Vector2IntField("Window Size", contextMenuWindowSize);
            ...
            {
                contextMenuOnRightClick = EditorGUILayout.ToggleLeft("Show Context Menu On Right Click", contextMenuOnRightClick);
