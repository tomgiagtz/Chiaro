...
namespace InfinityCode.uContext.Windows
{
    public partial class Search
    {
        internal abstract class Record : SearchableItem
        {
            ...
            {
                Rect rect = new Rect(0, index * 20, wnd.position.width, 20);
            ...
            protected virtual void PrepareContextMenuExtraItems(GenericMenu menu)
            {
            ...
            protected virtual void ShowContextMenu(int index)
            {
                ...
                menu.AddItem(new GUIContent("Select"), false, () => SelectRecord(index, 1));
                menu.AddItem(new GUIContent("Open"), false, () => SelectRecord(index, 2));
